...
assignées, comme celle de la documentation, ou de la paricipation à la 
...
actif est contenu dans un fichier particulier \cite{IOSchedulers} du système 
(changer le contenu du fichier change l'ordonnanceur actif).
...
Plus tard, j'ai du utiliser un réseau de serveurs externes français et dédié à 
la recherche appelé Grid'5000 pour effectuer des tests sur des machines plus 
performantes que ma machine personnelle. Pour cela j'ai du respecter une charte 
