...
et la validation de politiques d'E/S écrites par un utilisateur. Il est le 
fruit issu du projet VeriAMOS visant à s'attaquer au problème de vérification d'une classe de services de systèmes d'exploitation.
